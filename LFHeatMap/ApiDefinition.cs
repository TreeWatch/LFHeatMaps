...
namespace LFHeatMap
{
	...
	interface LFHeatMap
	{
        ...
        UIImage HeatMapWithRect (CGRect rect, float boost, NSValue[] points, NSNumber[] weights);
        ...
        UIImage HeatMapWithRect (CGRect rect, float boost, NSValue[] points, NSNumber[] weights, bool weightsAdjustmentEnabled, bool groupingEnabled);
	}
}
