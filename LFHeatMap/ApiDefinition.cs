...
namespace LFHeatMap
{
	...
	interface LFHeatMap
	{
		...
		UIImage HeatMapForMapView (MKMapView mapView, float boost, CGPoint[] locations, NSNumber[] weights);
		...
		UIImage HeatMapWithRect (CGRect rect, float boost, CGPoint[] points, NSNumber[] weights);
		...
		UIImage HeatMapWithRect (CGRect rect, float boost, CGPoint[] points, NSNumber[] weights, bool weightsAdjustmentEnabled, bool groupingEnabled);
	}
}
